# Zambezi Cashew CompanyWebApp Sample Data Documentation

This directory contains sample JSON data files for all Mock Services used by the Zambezi Cashew CompanyWebApp. These files provide realistic sample data for development, testing, and demonstration purposes.

## Overview

The Zambezi Cashew CompanyWebApp uses **51 Mock Services** that provide sample data when the application is running in development mode with `UseMockServices: true` in the configuration.

## Directory Structure

```
wwwroot/sample-data/zambezi-cashew-company/
├── README.md (this file)
├── zambezi-cashew-company-service.json
...
├── zambezi-cashew-company-period-service.json
├── audit-log-service.json
├── current-user-context.json
├── zambezi-cashew-company-settings-service.json
...
### Core Zambezi Cashew Company Services

#### 1. MockZambezi Cashew CompanyService
**File:** `zambezi-cashew-company-service.json`
**Purpose:** Main zambezi-cashew-company data including accounts, balances, and account types
...
#### 8. MockZambezi Cashew CompanyPeriodService
**File:** `zambezi-cashew-company-period-service.json`
...
#### 11. MockZambezi Cashew CompanySettingsService
**File:** `zambezi-cashew-company-settings-service.json`
**Purpose:** System-wide zambezi-cashew-company settings
...
The Zambezi Cashew CompanyWebApp uses these mock services when configured with `UseMockServices: true` in `appsettings.json`:
...
All mock services are registered in `ServiceCollectionExtensions.cs` using the `AddAdvancedZambezi Cashew CompanyMockServices()` extension method.
...
1. Locate the appropriate JSON file in `wwwroot/sample-data/zambezi-cashew-company/`
...
- **Method:** `AddAdvancedZambezi Cashew CompanyServices(useMockData: true)`
...
**Version:** 1.0
**Maintained By:** Zambezi Cashew Company-As-A-Service Development Team
