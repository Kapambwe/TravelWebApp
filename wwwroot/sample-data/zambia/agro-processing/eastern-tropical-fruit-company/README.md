# Eastern Tropical Fruit CompanyWebApp Sample Data Documentation

This directory contains sample JSON data files for all Mock Services used by the Eastern Tropical Fruit CompanyWebApp. These files provide realistic sample data for development, testing, and demonstration purposes.

## Overview

The Eastern Tropical Fruit CompanyWebApp uses **51 Mock Services** that provide sample data when the application is running in development mode with `UseMockServices: true` in the configuration.

## Directory Structure

```
wwwroot/sample-data/eastern-tropical-fruit-company/
├── README.md (this file)
├── eastern-tropical-fruit-company-service.json
...
├── eastern-tropical-fruit-company-period-service.json
├── audit-log-service.json
├── current-user-context.json
├── eastern-tropical-fruit-company-settings-service.json
...
### Core Eastern Tropical Fruit Company Services

#### 1. MockEastern Tropical Fruit CompanyService
**File:** `eastern-tropical-fruit-company-service.json`
**Purpose:** Main eastern-tropical-fruit-company data including accounts, balances, and account types
...
#### 8. MockEastern Tropical Fruit CompanyPeriodService
**File:** `eastern-tropical-fruit-company-period-service.json`
...
#### 11. MockEastern Tropical Fruit CompanySettingsService
**File:** `eastern-tropical-fruit-company-settings-service.json`
**Purpose:** System-wide eastern-tropical-fruit-company settings
...
The Eastern Tropical Fruit CompanyWebApp uses these mock services when configured with `UseMockServices: true` in `appsettings.json`:
...
All mock services are registered in `ServiceCollectionExtensions.cs` using the `AddAdvancedEastern Tropical Fruit CompanyMockServices()` extension method.
...
1. Locate the appropriate JSON file in `wwwroot/sample-data/eastern-tropical-fruit-company/`
...
- **Method:** `AddAdvancedEastern Tropical Fruit CompanyServices(useMockData: true)`
...
**Version:** 1.0
**Maintained By:** Eastern Tropical Fruit Company-As-A-Service Development Team
