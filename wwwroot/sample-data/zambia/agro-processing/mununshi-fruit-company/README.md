# Mununshi Fruit CompanyWebApp Sample Data Documentation

This directory contains sample JSON data files for all Mock Services used by the Mununshi Fruit CompanyWebApp. These files provide realistic sample data for development, testing, and demonstration purposes.

## Overview

The Mununshi Fruit CompanyWebApp uses **51 Mock Services** that provide sample data when the application is running in development mode with `UseMockServices: true` in the configuration.

## Directory Structure

```
wwwroot/sample-data/mununshi-fruit-company/
├── README.md (this file)
├── mununshi-fruit-company-service.json
...
├── mununshi-fruit-company-period-service.json
├── audit-log-service.json
├── current-user-context.json
├── mununshi-fruit-company-settings-service.json
...
### Core Mununshi Fruit Company Services

#### 1. MockMununshi Fruit CompanyService
**File:** `mununshi-fruit-company-service.json`
**Purpose:** Main mununshi-fruit-company data including accounts, balances, and account types
...
#### 8. MockMununshi Fruit CompanyPeriodService
**File:** `mununshi-fruit-company-period-service.json`
...
#### 11. MockMununshi Fruit CompanySettingsService
**File:** `mununshi-fruit-company-settings-service.json`
**Purpose:** System-wide mununshi-fruit-company settings
...
The Mununshi Fruit CompanyWebApp uses these mock services when configured with `UseMockServices: true` in `appsettings.json`:
...
All mock services are registered in `ServiceCollectionExtensions.cs` using the `AddAdvancedMununshi Fruit CompanyMockServices()` extension method.
...
1. Locate the appropriate JSON file in `wwwroot/sample-data/mununshi-fruit-company/`
...
- **Method:** `AddAdvancedMununshi Fruit CompanyServices(useMockData: true)`
...
**Version:** 1.0
**Maintained By:** Mununshi Fruit Company-As-A-Service Development Team
