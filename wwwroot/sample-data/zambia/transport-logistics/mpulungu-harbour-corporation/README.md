# Mpulungu Harbour Corporation LimitedWebApp Sample Data Documentation

This directory contains sample JSON data files for all Mock Services used by the Mpulungu Harbour Corporation LimitedWebApp. These files provide realistic sample data for development, testing, and demonstration purposes.

## Overview

The Mpulungu Harbour Corporation LimitedWebApp uses **51 Mock Services** that provide sample data when the application is running in development mode with `UseMockServices: true` in the configuration.

## Directory Structure

```
wwwroot/sample-data/mpulungu-harbour-corporation/
├── README.md (this file)
├── mpulungu-harbour-corporation-service.json
...
├── mpulungu-harbour-corporation-period-service.json
├── audit-log-service.json
├── current-user-context.json
├── mpulungu-harbour-corporation-settings-service.json
...
### Core Mpulungu Harbour Corporation Limited Services

#### 1. MockMpulungu Harbour Corporation LimitedService
**File:** `mpulungu-harbour-corporation-service.json`
**Purpose:** Main mpulungu-harbour-corporation data including accounts, balances, and account types
...
#### 8. MockMpulungu Harbour Corporation LimitedPeriodService
**File:** `mpulungu-harbour-corporation-period-service.json`
...
#### 11. MockMpulungu Harbour Corporation LimitedSettingsService
**File:** `mpulungu-harbour-corporation-settings-service.json`
**Purpose:** System-wide mpulungu-harbour-corporation settings
...
The Mpulungu Harbour Corporation LimitedWebApp uses these mock services when configured with `UseMockServices: true` in `appsettings.json`:
...
All mock services are registered in `ServiceCollectionExtensions.cs` using the `AddAdvancedMpulungu Harbour Corporation LimitedMockServices()` extension method.
...
1. Locate the appropriate JSON file in `wwwroot/sample-data/mpulungu-harbour-corporation/`
...
- **Method:** `AddAdvancedMpulungu Harbour Corporation LimitedServices(useMockData: true)`
...
**Version:** 1.0
**Maintained By:** Mpulungu Harbour Corporation Limited-As-A-Service Development Team
